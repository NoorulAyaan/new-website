...
export function CustomerDashboard() {
  ...
  useEffect(() => {
    // Try fetching from API; fall back to empty array so frontend remains functional
    fetch("/api/parts")
      .then((res) => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-3xl font-bold text-gray-900">Shop Spare Parts</h1>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by part name, vehicle, model, or engine..."
              value={searchQuery}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-gray-600 mb-4">
          Found {filteredParts.length} part{filteredParts.length !== 1 ? "s" : ""}
        </p>
